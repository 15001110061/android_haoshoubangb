 ...
 * 
 */
public class SampledWaitingAdapter extends BaseAdapter {
	...
	public SampledWaitingAdapter(Context contexts) {
	...
	private View getInviteView(final int position, View convertView) {
		...
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.activity_sampled_dai_item, null);
	...
	class ViewHolder {
		...
		TextView tv_current_name, tv_current_room, tv_current_peonumber2, tv_current_time, tv_current_yanshou;
	}
